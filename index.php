...
<html lang="fr">
<?php
	/* D�termination du nom de la page � charger apr�s v�rification de sa validit� */
...
<body>
	...
	<div id="Bandeau">
		...
		<div class="contenuDiv">
			bandeau de mon super site vraiment génial génial génial ! bla bla ! Clément est arrivée
		</div>
	</div>
